...
lib.ssMetadata = [
		{name:"CronopiosHcuadrGenially_atlas_", frames: [[0,1019,997,262],[0,1283,53,53],[0,0,1013,1017]]}
];
...
// stage content:
(lib.CronopiosHcuadrGenially = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
